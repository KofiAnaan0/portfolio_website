...
export default function AIChatBox({ open, onClose }: AIChatBoxProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-[700px] flex-col rounded border bg-background shadow-xl sm:h-[500px]">
          ...
          {!error && messages.length === 0 && (
            <div className="mx-8 flex h-full flex-col items-center justify-center gap-3 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                For gigs, colloboration & connection, send me a DM on{" "}
                <a
                  href="https://wa.me/256786436716/?text=Hi%20Santos,%20I%20just%20came%20across%20your%20portfolio%20website%20and%20wanted%20to%20reach%20out!"
